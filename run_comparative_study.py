...
from src.utils import generate_synthetic_spaces
from src.engine import run_evolutionary_clustering
from src.visualization import plot_pareto_fronts  # IMPORT NEW PLOTTING LAYER
...
def main():
    ...
    print("\n🎨 Generating comparative analytical diagrams...")
    plot_pareto_fronts(classical_pareto_front, embedding_front=embedding_pareto_front)
